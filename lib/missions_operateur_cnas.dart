...
import 'package:techme/mission_detail_cnas_screen.dart';
...
class MissionsOperateurCnas extends StatefulWidget {
  MissionsOperateurCnas({this.idOperateur, Key? key}) : super(key: key);
  String? idOperateur;
...
class _State extends State<MissionsOperateurCnas> {
  void _seconnecter() {}
                        ...
                        if (snapshot1.connectionState ==
                          ...
                          if (snapshot1.hasError) {
                            ...
                            return FutureBuilder<TransportateursModel>(
                                future:
                                    apiService.getOperateursAllTransportateur(
                                        widget.idOperateur!),
                                builder: (
                                  BuildContext context,
                                  ...
                                  if (snapshot.connectionState ==
                                    ...
                                    if (snapshot.hasError) {
                                      ...
                                      for (int i = 0;
                                          i < snapshot1.data!.missions!.length;
                                          i++) {
                                        for (int j = 0;
                                            j <
                                                snapshot.data!.transportateur!
                                                    .length;
                                            j++) {
                                          if (snapshot1.data!.missions![i]
                                                      .prenom_transportateur ==
                                                  snapshot
                                                      .data!
                                                      .transportateur![j]
                                                      .prenom &&
                                              snapshot1.data!.missions![i]
                                                      .nom_transportateur ==
                                                  snapshot.data!
                                                      .transportateur![j].nom) {
                                            missionsOperateur.add(
                                                snapshot1.data!.missions![i]);
                                          }
                                        }
                                      }
                                                            ...
                                                            onPressed: () {
                                                              Navigator.push(
                                                                ...
                                                                MaterialPageRoute(
                                                                    builder:
                                                                        (context) =>
                                                                            MissionDetailCnasScreen(
                                                                              missionModel: missionsOperateur[index],
                                                                            )),
                                                              );
                                                            },
                                                            child: const Text(
