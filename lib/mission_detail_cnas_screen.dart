...
class MissionDetailCnasScreen extends StatefulWidget {
  MissionDetailCnasScreen({this.missionModel, Key? key}) : super(key: key);
...
class _State extends State<MissionDetailCnasScreen> {
  @override
