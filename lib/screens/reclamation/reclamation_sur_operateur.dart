...
class ReclamationSurOperateur extends StatefulWidget {
  const ReclamationSurOperateur({Key? key}) : super(key: key);

  @override
  _State createState() => _State();
}

class _State extends State<ReclamationSurOperateur> {
                    ...
                    children: [
                      ...
                      Row(
                        children: const [
                          ...
                          Text(
                            'Renseignement concernant l emetteur de la réclamation',
                            style: TextStyle(
                                color: Colors.orange,
                                fontWeight: FontWeight.w700,
                                fontSize: 18),
                                  ...
                                  SizedBox(
                                    ...
                                    child:  Checkbox(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          si_assure = value!;
                                          reclamationModel.si_assure = si_assure.toString();
                                        });
                                      },
                                    ),
                                  ),
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onChanged: (val) {
                                        setState(() {
                                          reclamationModel.numero_telephone = val;
                                        });
                                      },
                                    ),
                                  ),
